...
# Image Oaths
title_dashboard_logo = '.\Generic_AnalyticsWebApp\dash_small.png'
sidebar_streamlit_logo = '.\Generic_AnalyticsWebApp\streamlit-logo-nbg.png'
main_waiting_logo = '.\Generic_AnalyticsWebApp\Waiting.png'
